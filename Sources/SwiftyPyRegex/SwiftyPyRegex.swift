...
public class re {
  ...
  */
  public static func search(_ pattern: RegexObject, _ string: String, flags: RegexObject.Flag = []) -> MatchObject? {
  ...
  */
  ...
  public static func match(_ pattern: RegexObject, _ string: String, flags: RegexObject.Flag = []) -> MatchObject? {
  ...
  */
  ...
  public static func split(_ pattern: RegexObject, _ string: String, _ maxsplit: Int = 0, flags: RegexObject.Flag = []) -> [String?] {
  ...
  */
  ...
  public static func findall(_ pattern: RegexObject, _ string: String, flags: RegexObject.Flag = []) -> [String] {
  ...
  */
  ...
  public static func finditer(_ pattern: RegexObject, _ string: String, flags: RegexObject.Flag = []) -> [MatchObject] {
  ...
  */
  ...
  public static func sub(_ pattern: RegexObject, _ repl: String, _ string: String, _ count: Int = 0, flags: RegexObject.Flag = []) -> String {
  ...
  public static func sub(_ pattern: RegexObject, _ replfunc: (re.MatchObject) -> String, _ string: String, _ count: Int = 0, flags: RegexObject.Flag = []) -> String {
    return pattern.sub(replfunc, string, count)
  }
  ...
  */
  ...
  public static func subn(_ pattern: RegexObject, _ repl: String, _ string: String, _ count: Int = 0) -> (String, Int) {
    ...
    public func subn(_ replfunc: (re.MatchObject) -> String, _ string: String, _ count: Int = 0) -> (String, Int) {
      ...
      regex.enumerateMatches(in: string, options: [], range: range) { result, _, stop in
        ...
        if let result = result {
          ...
          let lengthBeforeReplace = string.utf16.count
          let matchobj = MatchObject(string: string, match: result)
          string = regex.stringByReplacingMatches(in: string, options: [], range: resultRange, withTemplate: replfunc(matchobj))
          offset += string.utf16.count - lengthBeforeReplace
        }
      }
      return (string, n)
    } 
